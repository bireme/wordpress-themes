...
function tmgl_register_menus()
{
    register_nav_menus(array(
        ...
        'footer-right-top' => __('Footer Right Top', 'tmgl'),
...
{
    $labels = array(
        'name' => _x('Resources', 'Additional Resources for objects from external sources', 'textdomain'),
        ...
        'archives' => __('Item Resources', 'textdomain'),
        'attributes' => __('Item Resources', 'textdomain'),
    ...
    $args = array(
        ...
        'description' => __('Post Type for Resources', 'textdomain'),
        'labels' => $labels,
...
add_action('resources', 'create_resources_cpt', 0);


function create_events_cpt()
{
    $labels = array(
        'name' => _x('Events', '', 'textdomain'),
        'singular_name' => _x('Event', 'Post Type Singular Name', 'textdomain'),
        'menu_name' => __('Events', 'textdomain'),
        'name_admin_bar' => __('Events', 'textdomain'),
        'archives' => __('Item Events', 'textdomain'),
        'attributes' => __('Item Events', 'textdomain'),
        'parent_item_colon' => __('Parent Item:', 'textdomain'),
        'all_items' => __('All Items', 'textdomain'),
        'add_new_item' => __('Add New Item', 'textdomain'),
        'add_new' => __('Add New', 'textdomain'),
