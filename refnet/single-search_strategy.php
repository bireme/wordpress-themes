...
<div id="primary" class="site-content">
    <div id="content" class="single1column" role="main">
        <div class="search-strategy-data">
            ...
            <dl>
            <?php
                echo bir_show_custom_field_translated(get_the_ID(), 'search_strategy_II_observations', __('Observation','refnet'), $html4label, $html4custom_field);
            ?>
            </dl>
            <dl class="expr">
            <?php
            ...
            <dl>
            <?php
                echo bir_show_custom_field_translated(get_the_ID(), 'search_strategy_III_observations', __('Observation','refnet'), $html4label, $html4custom_field);
            ?>
            </dl>
            <dl class="expr">
            <?php
            ...
            <!-- START: Pubmed Search Strategy -->
            <?php 
                $custom_field_keys = array("pubmed_search_strategy_information", "pubmed_search_strategy_expression");
                if ( bir_has_no_empty_custom_field( get_the_ID(), $custom_field_keys ) ) {
                    echo "<h5>";
                    echo "<i class='databases'></i>";
                    echo __('Search strategy','refnet') . " (Pubmed)";
                    echo "</h5>";
                }
            ?>
            <dl>
            <?php
                echo bir_show_custom_field_translated( get_the_ID(), 'pubmed_search_strategy_information', __('Observation','refnet'), $html4label, $html4custom_field );
            ?>
            </dl>
            <dl class="expr">
            <?php                
            ...
            <!-- START: Cochrane Search Strategy -->
            <?php 
                $custom_field_keys = array("cochrane_search_strategy_information", "cochrane_search_strategy_expression");
                if ( bir_has_no_empty_custom_field( get_the_ID(), $custom_field_keys ) ) {
                    echo "<h5>";
                    echo "<i class='databases'></i>";
                    echo __('Search strategy','refnet') . " (Cochrane)";
                    echo "</h5>";
                }
            ?>
            <dl>
            <?php
                echo bir_show_custom_field_translated( get_the_ID(), 'cochrane_search_strategy_information', __('Observation','refnet'), $html4label, $html4custom_field );
            ?>
            </dl>
            <dl class="expr">
            <?php                
            ...
            <!-- START: Other Databases Search Strategy -->
            <?php 
                $custom_field_keys = array("other_search_strategy_information", "other_search_strategy_expression");
                if ( bir_has_no_empty_custom_field( get_the_ID(), $custom_field_keys ) ) {
                    echo "<h5>";
                    echo "<i class='databases'></i>";
                    echo __('Search strategy','refnet') . " (other databases)";
                    echo "</h5>";
                }
            ?>
            <dl>
            <?php
                echo bir_show_custom_field_translated( get_the_ID(), 'other_search_strategy_information', __('Observation','refnet'), $html4label, $html4custom_field );
            ?>
            </dl>
            <dl class="expr">
            <?php                
