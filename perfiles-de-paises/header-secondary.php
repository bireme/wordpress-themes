...
<body>
		...
		<div class="container">
			<div class="row" style="position: relative;">
				<div class="col-12" id="brand">
					<a href="<?php echo get_option('siteurl'); ?>/<?php echo $language=='es'?'':$language; ?>"><img src="<?php bloginfo('template_directory'); ?>/img/logo-<?=$language; ?>.png" alt="" class="img-fluid" id="logo" ></a>
				</div>
				<div id="language">
					<?php 
					wp_nav_menu( array(
	...
	<?php get_template_part('includes/nav-secondary') ?>
