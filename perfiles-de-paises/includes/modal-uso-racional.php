<!------------------ Uso de las Tecnologías de salud - Uso Racional: -->
<div class="modal fade" id="usoRacional" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-xl modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title"><small class="badge bg-light text-dark"><?php pll_e('Uso de las Tecnologías de Salud'); ?></small> > <?php pll_e('Uso Racional'); ?>:</h5>
