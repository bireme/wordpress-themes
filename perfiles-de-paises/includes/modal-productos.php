<!------------------ Productos de ETS -->
<div class="modal fade" id="produtosETS" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-xl modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title"><?php pll_e('Productos de ETS'); ?>:</h5>
      ...
      <div class="modal-body">
        ...
        while($fichas->have_posts()) : $fichas->the_post();
          ...
          $text = get_field('productos_de_ets');
          ?>
