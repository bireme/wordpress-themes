					...
					<div class="row">
						<div class="col-12">
							<button type="button" class="btn btn-link" data-toggle="modal" data-target="#modal-taxonomy-mobile">
								<img class="img-fluid" src="<?php echo get_stylesheet_directory_uri().'/assets/img/icons/quem-perguntou.png'; ?>" alt="<?php _e('Quem Perguntou', 'bvs_lang'); ?>?">
							</button>
				  ...
				  <div class="modal-dialog modal-dialog-centered" role="document">
				    <div class="modal-content">
				      ...
				      <div class="modal-body">
				      	<h2 class="title-taxonomy"><?php _e('Quem Perguntou', 'bvs_lang'); ?>?</h2>
