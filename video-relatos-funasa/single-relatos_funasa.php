			...
			<?php while ( have_posts() ) : the_post(); ?>
                                ...
                                <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                                        ...
                                        <div <?php post_class() ?> id="post-<?php the_ID(); ?>">
                                                <?php if ( is_single() ) : ?>
                                                <div class="entry-content"><div class="r-block-title">Objetivo Geral</div>
                                                        <?php the_content(); ?>
                                                </div>
                                                <?php endif; ?>
                                        </div>
                                          <div class="related_links r-block">
                                                ...
                                                <?php echo pods_field( "relatos_funasa", $post->ID, 'instituio_executora', true ); ?>
                                            </div>
                                            <div class="related_links r-block">
                                                <div class="r-block-title">Coordenador(a) do projeto de pesquisa</div>
                                                <?php //$key="links_relacionados"; echo get_post_meta($post->ID, $key, true); ?>
                                                <?php echo pods_field( "relatos_funasa", $post->ID, 'coordenadora_do_projeto_de_pesquisa', true ); ?>
                                            </div>
             
                                            <div class="related_links r-block"><div class="r-block-title">Imagem</div>
                                                <?php //$key="links_relacionados"; echo get_post_meta($post->ID, $key, true); ?>
                                                <?php echo pods_field( "relatos_funasa", $post->ID, 'imagem', true ); ?>
                                            </div>
                                            <div class="related_links r-block">
                                                <div class="r-block-title">Produto</div>
                                                <?php //$key="links_relacionados"; echo get_post_meta($post->ID, $key, true); ?>
                                                <?php echo pods_field( "relatos_funasa", $post->ID, 'produto', true ); ?>
                                            </div>
                                             <div class="related_links r-block">
                                                <div class="r-block-title">Publicação</div>
                                                <?php //$key="links_relacionados"; echo get_post_meta($post->ID, $key, true); ?>
                                                <?php echo pods_field( "relatos_funasa", $post->ID, 'publicao', true ); ?>
                                            </div>
                                            <div class="related_links r-block">
                                                <div class="r-block-title">Links relacionados</div>
                                                <?php //$key="links_relacionados"; echo get_post_meta($post->ID, $key, true); ?>
                                                <?php echo pods_field( "relatos_funasa", $post->ID, 'links_relacionados', true ); ?>
                                            </div>
