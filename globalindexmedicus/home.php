	...
	<div class="container text-center">
		<div class="row">
			...
			<div class="col-md-8">
				...
				<h5><a href="<?php bloginfo('template_directory') ?>/img/guia<?php echo ( in_array($idioma, ['ar', 'fr', 'ru', 'zh']) ? "en" : $idioma ); ?>.pdf" target="_blank" class="btn btn-lg btn-warning"><?php pll_e('Clique para baixar o guia rápido de pesquisa GIM'); ?></a></h5>
			</div>
		</div>
	</div>
</section>
