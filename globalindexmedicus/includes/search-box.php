		...
		<form action="http://search.bvsalud.org/ghl/" id="formBusca" method="get">
			...
			<div class="row">
				...
				<div class="col-md-6 text-right d-none d-md-block">
					<a href="http://pesquisa.bvsalud.org/portal/decs-locator/?lang=pt"><?php pll_e('Pesquisa via descritores'); ?> DeCS/MeSH</a>
				</div>
				<div class="col-md-12">
				...
				<div class="col-md-6 text-right d-sm-block d-md-none">
					<a href="http://search.bvsalud.org/ghl/decs-locator/?lang=pt">Pesquisa via descritores DeCS/MeSH</a>
				</div>
			</div>
		</form>
	</div>
