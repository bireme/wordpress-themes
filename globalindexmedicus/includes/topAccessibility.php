	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6" id="acessibilidadeFontes">
				<a href="#!" role="button" id="fontPlus" tabindex="5" aria-hidden="true">+A</a>
				<a href="#!" role="button" id="fontNormal" tabindex="6" aria-hidden="true">A</a>
				<a href="#!" role="button" id="fontLess" tabindex="7" aria-hidden="true">-A</a>
				<a href="#!" role="button" id="contraste" tabindex="8" aria-hidden="true"><i class="fas fa-adjust"></i> <?php pll_e('High contrast'); ?></a>
