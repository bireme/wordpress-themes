    ...
    <div class="container pt-5">
        ...
        <div class="row mt-5">
            <div class="col-md-8 offset-md-2 text-center">
                <p>
                   <?php echo pll__('O Memorial Digital da Pandemia de COVID-19 reúne depoimentos de cidadãos, profissionais de saúde e familiares sobre suas experiências, memórias e vivências durante a pandemia, preservando histórias e reflexões sobre esse período marcante da história'); ?>
                </p>
