...
if ($idioma == 'en') { ?>
	...
	<div id="feedbackBox">
		...
		<hr>
		<a href="https://forms.gle/ETXwxZWX4RtnrT2G7" class="btn btn-primary" target="_blank">Go to survey</a>
	</div>
	<div id="feedbackIcone">
...
if ($idioma == 'fr') { ?>
	...
	<div id="feedbackIcone">
		<img src="<?php bloginfo('template_directory');?>/img/iconFeedback-fr.svg" alt="">
	</div>
	<div class="clear"></div>
</div>
<?php  } ?>