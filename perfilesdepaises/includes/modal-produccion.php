<!------------------ Aspectos metodológicos y de procedimientos - Producción y ejecución: -->
<div class="modal fade" id="produccion" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-xl modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title"><small class="badge bg-light text-dark"><?php pll_e('Aspectos metodológicos y procedimentales'); ?></small> > <?php pll_e('Producción y ejecución'); ?>:</h5>
      ...
      <div class="modal-body">
        ...
        while($fichas->have_posts()) : $fichas->the_post();
          ...
          $text = get_field('produccion_y_ejecucion');
          ?>
