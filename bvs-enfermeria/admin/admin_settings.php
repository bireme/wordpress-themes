		...
		<div id="poststuff">
			<form method="post" action="<?php admin_url( 'themes.php?page=theme-settings' ); ?>">
				...
				if ( $pagenow == 'themes.php' && $_GET['page'] == 'theme-settings' ){
					...
					switch ( $tab ){
						case 'header' : include(TEMPLATEPATH . "/admin/header.php"); break;
						case 'colors' : include(TEMPLATEPATH . "/admin/colors.php"); break;
						case 'layout': default: include(TEMPLATEPATH . "/admin/layout.php"); break;
