						...
						<a href="<?php echo $link; ?>" target="<?php echo $abrir; ?>">
							<div class="row">
								<div class="col-md-4">
									<?php 
									if ( $foto == "") { ?>
										<img src="<?php bloginfo('template_directory')?>/img/temaIndisponivel.jpg" class="img-fluid" alt="sem fotos">
									<?php }else{ ?>
					...
					while($home->have_posts()) : $home->the_post();
						...
						while( have_rows('recursos') ): the_row(); 
							...
							<div class="col-6 col-md-4 col-lg margin2">
								<div class="card cardRecursos">
									<div class="card-body text-center">
										<a href="<?php echo $link_politicas; ?>">
											<img src="<?php bloginfo('template_directory') ?>/img/icone-politicas.svg" width="150" alt="Políticas e Diretrizes do SUS">
								...
								<div class="card cardRecursos">
									<div class="card-body text-center">
										<a href="<?php echo $link_protocolos; ?>" target="_blank">
											<img src="<?php bloginfo('template_directory') ?>/img/icone-protocolos.svg" width="150" alt="Protocolos Clinícos">
											Protocolos Clinícos
										</a>
									</div>
								</div>
							...
							<div class="col-6 col-md-4 col-lg margin2">
								<div class="card cardRecursos">
									<div class="card-body text-center">
										<a href="<?php echo $link_atencao; ?>">
											<img src="<?php bloginfo('template_directory') ?>/img/icone-protocolos2.svg" width="150" alt="Protocolos da Atenção Básica">
							...
							<div class="col-6 col-md-4 col-lg margin2">
								<div class="card cardRecursos">
									<div class="card-body text-center">
										<a href="<?php echo $link_indicadores; ?>">
											<img src="<?php bloginfo('template_directory') ?>/img/icone-indicadores.svg" width="150" alt="Indicadores de Saúde e Sistemas de Informação">
								...
								<div class="card cardRecursos">
									<div class="card-body text-center">
										<a href="<?php echo $link_tabelas; ?>" target="_blank">
											<img src="<?php bloginfo('template_directory') ?>/img/icone-tabela.svg" width="150" alt="Tabelas de Procedimentos SIGTAP">
