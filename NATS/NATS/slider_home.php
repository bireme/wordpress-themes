...
class My_Widget_Slider_Categories extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
            'my_categories', // Base ID
            __('Home Slider Category Widget', 'text_domain'), // Name
            array('description' => __('Slider de posts feito em Bootstrap por categoria', 'text_domain')) // Args
        );
    }
...
?>
        <div id="carouselIndicators" class="carousel slide" data-ride="carousel">
            ...
            <?php if ( $query->have_posts() ) : 
                $active = "active"; // Set the first carousel item as active
                ...
                <?php 
                    // After the first item, set $active to an empty string
                    $active = ""; 
                ?>
...
add_action('widgets_init', function() { register_widget('My_Widget_Slider_Categories'); });
?>
