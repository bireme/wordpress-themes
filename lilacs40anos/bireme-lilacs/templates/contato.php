...
<div class="faq-content" id="faq-detail">
 ...
 <div class="faq-content-text">
  ...
  <div class="faq-buttons">
    <button class="lilacs"><a style="color:#fff !Important; text-decoration:none !Important;" href="<?=$btn1_url?>"><?=$btn1_text?></a></button>
    <button class="revistas"><a style="color:#fff !Important; text-decoration:none !Important;" href="<?=$btn2_url?>"><?=$btn2_text?></a></button>
  </div>
</div>
</div>
