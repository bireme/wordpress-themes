...
const BIREME_LILACS_CP_META_BANNER_PHRASE = '_lilacs_cp_banner_phrase';
...
add_action('add_meta_boxes', function ($post_type, $post) {
  ...
  // recupera template da página (valor armazenado em _wp_page_template)
  $tpl = get_post_meta($post->ID, '_wp_page_template', true);

  // normaliza para o basename, assim aceita também caminhos como "templates/page-....php"
...
function bireme_lilacs_cp_render_metabox($post){
  ...
  ?>
  <style>
    /* ...existing styles (mantive os estilos anteriores) ... */
    ...
    <div id="tab-banner" class="lilacs-tab is-active">
      <div class="lilacs-fields">
        ...
        <div class="field">
            ...
            <textarea id="lilacs_cp_banner_desc" name="lilacs_cp_banner_desc" placeholder="<?php esc_attr_e('Ex.: Acesse artigos, periódicos científicos e documentos técnicos…', 'bireme'); ?>"><?php echo esc_textarea($desc); ?></textarea>
        </div>

    <?php
      $phrase = get_post_meta($post->ID, BIREME_LILACS_CP_META_BANNER_PHRASE, true);
    ?>
        <div class="field">
          <label for="lilacs_cp_banner_phrase"><?php _e('Frase destaque', 'bireme'); ?></label>
          <textarea id="lilacs_cp_banner_phrase" name="lilacs_cp_banner_phrase"
            placeholder="<?php esc_attr_e('Ex.: A principal base de dados científica da América Latina…', 'bireme'); ?>"><?php
              echo esc_textarea($phrase);
          ?></textarea>
          <p class="lilacs-help"><?php _e('Opcional. Exibida como frase de destaque no banner.', 'bireme'); ?></p>
        </div>
...
add_action('save_post_page', function($post_id){
  ...
  $phrase = isset($_POST['lilacs_cp_banner_phrase'])? wp_kses_post($_POST['lilacs_cp_banner_phrase']) : '';
  ...
  update_post_meta($post_id, BIREME_LILACS_CP_META_BANNER_PHRASE, $phrase);
