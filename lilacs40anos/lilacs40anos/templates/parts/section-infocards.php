    ...
    <div class="info-cards-section">
        <div class="info-card">
            <div class="image-placeholder-small">
                ...
                <img src="<?php echo get_template_directory_uri(); ?>images/infocard1.png" alt="Site de comemoração de 35 anos">
            </div>
        ...
        <div class="info-card">
            <div class="image-placeholder-small">
                <!-- Espaço para a imagem a ser preenchida manualmente -->
                <img src="<?php echo get_template_directory_uri(); ?>images/infocard2.png" alt="Principais marcos históricos da LILACS">
            </div>
        ...
        <div class="info-card">
            <div class="image-placeholder-small">
                <!-- Espaço para a imagem a ser preenchida manualmente -->
                <img src="<?php echo get_template_directory_uri(); ?>images/infocard3.png" alt="Referências sobre a LILACS">
            </div>
