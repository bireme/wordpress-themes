	...
	<?php if ( 'request-completed' === $request->status ) : ?>
		...
		<?php else : ?>
			...
			<form id="bp-data-export" method="post">
				...
				<button type="submit" class="btn btn-primary" name="bp-data-export-nonce" value="<?php echo esc_attr( wp_create_nonce( 'bp-data-export' ) ); ?>"><?php esc_html_e( 'Request new data export', 'buddypress' ); ?></button>
			</form>
...
<?php else : ?>
	...
	<form id="bp-data-export" method="post">
		<button type="submit" class="btn btn-primary" name="bp-data-export-nonce" value="<?php echo esc_attr( wp_create_nonce( 'bp-data-export' ) ); ?>"><?php esc_html_e( 'Request personal data export', 'buddypress' ); ?></button>
	</form>
