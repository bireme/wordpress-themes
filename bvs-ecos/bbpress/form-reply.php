				...
				<div class="grid-form-reply">
					...
					<?php if ( bbp_allow_topic_tags() && current_user_can( 'assign_topic_tags', bbp_get_topic_id() ) ) : ?>
						...
						<div class="grid-form-group">
							...
							<small><?php _e('Separe as tags com vírgula', 'bvs-ecos'); ?></small>
						</div>
					...
					<?php if ( bbp_is_subscriptions_active() && ! bbp_is_anonymous() && ( ! bbp_is_reply_edit() || ( bbp_is_reply_edit() && ! bbp_is_reply_anonymous() ) ) ) : ?>
						...
						<div class="grid-form-group d-flex align-items-center mb-0">

							<input name="bbp_topic_subscription" id="bbp_topic_subscription" type="checkbox" class="form-check-input" value="bbp_subscribe"<?php bbp_form_topic_subscribed(); ?> />

							<?php if ( bbp_is_reply_edit() && ( bbp_get_reply_author_id() !== bbp_get_current_user_id() ) ) : ?>

								<label for="bbp_topic_subscription" class="form-check-label"><?php esc_html_e( 'Notify the author of follow-up replies via email', 'bbpress' ); ?></label>

							<?php else : ?>

								<label for="bbp_topic_subscription" class="form-check-label"><?php esc_html_e( 'Notify me of follow-up replies via email', 'bbpress' ); ?></label>
					...
					<div class="bbp-submit-wrapper">
						...
						<button type="submit" id="bbp_reply_submit" name="bbp_reply_submit" class="btn btn-primary button submit"><?php esc_html_e( 'Submit', 'bbpress' ); ?></button>
