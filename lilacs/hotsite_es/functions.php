...
function widget_PesquisaLILACS_ES_widget($args) {
      ...
      ?>
            ...
            <form name="searchForm" action="http://pesquisa.bvsalud.org/portal/" method="post">
                ...
                <div id="search00" style="display: inline;">
                    <select class="inputText mini" name="index">
                        <option selected="true" value="">Todos los índices</option>
                        <option value="ti">Título</option>
                        <option value="au">Autor</option>
                        <option value="mh_words">Asunto</option>
                     </select>
                     <input type="submit" value="Buscar" name="submit" class="submit">
                 </div>
                 <div id="search01" style="display: none;">
                     <input type="submit" value="Buscar" name="submit" class="submit">
                 </div>
                 <div class="search_advanced">
                     <a href="http://bases.bireme.br/cgi-bin/wxislind.exe/iah/online/?IsisScript=iah/iah.xis&base=LILACS&lang=e&form=A">Búsqueda via formulario iAH</a>
                 </div>
             </form>
