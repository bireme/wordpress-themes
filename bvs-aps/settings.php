...
function bvs_aps_page_admin() {
    ...
    $home_url = ( empty($config['home_url']) ) ? '' : rtrim($config['home_url'], '/');
?>
    <div class="wrap">
            ...
            <table class="form-table">
                <tbody>
                    <tr valign="top">
                        ...
                        <td><input type="text" name="bvs_aps_config[home_url]" value="<?php echo $home_url; ?>" class="regular-text code"></td>
                    </tr>
                </tbody>
            </table>
            <p class="submit">
