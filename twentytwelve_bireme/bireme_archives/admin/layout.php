...
<table class="form-table">
	<tbody>
		<tr>
			...
			<td>
				<input id="layout[background]" name="layout[background]" type="text" class="regular-text code" value="<?php echo esc_html( stripslashes( $settings["layout"]["background"] ) ); ?>"></br>
			</td>
		</tr>
	</tbody>
</table>
		...
		<tr>
			...
			<td>
				<select class="columns" id="default_columns" name="layout[total]">
					<option <? if($layout['total'] == "1") echo "selected='selected'"; ?> value="1">1 coluna</option>
					<option <? if($layout['total'] == "2") echo "selected='selected'"; ?> value="2">2 colunas</option>
					<option <? if($layout['total'] == "3") echo "selected='selected'"; ?> value="3">3 colunas</option>
					<option <? if($layout['total'] == "4") echo "selected='selected'"; ?> value="4">4 colunas</option>
				</select>
			</td>
		</tr>
	</tbody>
...
<table class="form-table">
	<tbody>
		...
		<tr id="wp_bvs_column2-width-tr" <? if($layout['total'] < 2) echo "style='display: none'"; ?> class="columns-tr">
		...
		<tr id="wp_bvs_column3-width-tr" <? if($layout['total'] < 3) echo "style='display: none'"; ?> class="columns-tr">
		...
		<tr id="wp_bvs_column4-width-tr" <? if($layout['total'] < 4) echo "style='display: none'"; ?> class="columns-tr">
...
<table class="form-table">
	<tbody> 
		<tr>
			...
			<td>
				<input id="layout[top-sidebar]" name="layout[top-sidebar]" type="checkbox" class="" value="true" <?if($settings['layout']['top-sidebar'] == 'true') { echo "checked"; } ?> ></br>
			</td>
		</tr>
		<tr>
			<th><label for="layout[footer-sidebar]">Footer</label></th>
			<td>
				<input id="layout[footer-sidebar]" name="layout[footer-sidebar]" type="checkbox" class="" value="true" <?if($settings['layout']['footer-sidebar'] == 'true') { echo "checked"; } ?> ></br>
			</td>
		</tr>
	</tbody>
</table>
