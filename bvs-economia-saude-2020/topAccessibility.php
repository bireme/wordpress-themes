	...
	<div class="container">
		<div class="row">
			<div class="col-md-6" id="accessibilityTutorial">
				<a href="#primary" tabindex="1" role="button"><?php pll_e('Main content'); ?> <span class="hiddenMobile">1</span></a>
				<a href="#menu-menu-principal" tabindex="2" role="button"><?php pll_e('Menu'); ?> <span class="hiddenMobile">2</span></a>
				<a href="#vhl-search-input" tabindex="3" id="accessibilitySearch" role="button"><?php pll_e('Search'); ?> <span class="hiddenMobile">3</span></a>
