<?php
/**
 * Template para listagem de posts (Notícias da Rede) no layout moderno da BVS
 */
 ...
 * ---------------------------
 */
$arquivo_titulo = get_the_archive_title();

// imagem padrão do banner (pode trocar depois se quiser)
...
<section class="sobre-banner">
    <div class="sobre-banner-inner">
        ...
        <div class="sobre-banner-breadcrumb">
            <?php
        ...
        <div class="sobre-banner-wrapper">
            <div class="sobre-banner-image" style="background-image:url('<?php echo esc_url( $banner_img ); ?>');">
                <div class="sobre-banner-overlay"></div>
                <div class="sobre-banner-text">
                    <h1><?php echo $arquivo_titulo; ?></h1>
                </div>
            </div>
        </div>
                    ...
                    <div class="bvs-post-thumb">
                        <a href="<?php the_permalink(); ?>">
                            ...
                            if ( has_post_thumbnail() ) {
                                ...
                                echo '<img src="' . esc_url( get_template_directory_uri() . '/assets/post-default.png' ) . '" alt="Imagem padrão">';
                            }
                            ?>
                        </a>
                    </div>
