...
.bvs-search-target.is-active{
    ...
    color: <?=$cor_contraste_destaque?> !important;
    border-color: #ffffff;
    font-weight: 500;
}
...
.home-a-rede-col-right {
    ...
    position: relative; /* permite o map "escapar" usando left/transform */
}
...
#map text{
    fill: <?=$cor_contraste_destaque;?>;
}
/* MAPA ocupando 100% da largura da tela no desktop */
#map {
    width: 100vw;
    max-width: none;
    height: 520px;
...
/* Contêiner "genérico" que não estamos usando aqui, mas mantido */
.home-a-rede-map {
    width: 100%;
    max-width: 420px;
    aspect-ratio: 4 / 3;
...
@media (max-width: 900px) {
    ...
    /* no mobile, mapa volta a respeitar largura do container */
    #map {
        width: 100% !important;
...
// Configuração fixa de coordenadas dos países
const countryConfig = { 
  "Brasil":               { coords: [-14.2350, -51.9253] },
  "Argentina":            { coords: [-38.4161, -63.6167] },
  "Paraguai":             { coords: [-23.4425, -58.4438] },
  "Uruguai":              { coords: [-32.5228, -55.7658] },
  "Chile":                { coords: [-35.6751, -71.5430] },
  "Bolívia":              { coords: [-16.2902, -63.5887] },
  "Peru":                 { coords: [-9.1900, -75.0152] },
  "Equador":              { coords: [-1.8312, -78.1834] },
  "Colômbia":             { coords: [4.5709, -74.2973] },
  "Venezuela":            { coords: [6.4238, -66.5897] },

  "México":               { coords: [23.6345, -102.5528] },
  "Guatemala":            { coords: [15.7835, -90.2308] },
  "El Salvador":          { coords: [13.7942, -88.8965] },
  "Honduras":             { coords: [15.2000, -86.2419] },
  "Nicarágua":            { coords: [12.8654, -85.2072] },
  "Costa Rica":           { coords: [9.7489, -83.7534] },
  "Panamá":               { coords: [8.5380, -80.7821] },

  "Cuba":                 { coords: [21.5218, -77.7812] },
  "República Dominicana": { coords: [18.7357, -70.1627] },
  "Porto Rico":           { coords: [18.2208, -66.5901] },
  "Haiti":                { coords: [18.9712, -72.2852] },

  "Moçambique":           { coords: [-18.6657, 35.5296] },
};
