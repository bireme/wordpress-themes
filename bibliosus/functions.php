<?php
	...
	function registrar_custom_post_type() {
		...
		$Produtos = array(
			...
			'add_new' 				=> 'Add Produto',
			'add_new_item' 			=> 'Add Produtos Item',
			'edit_item' 			=> 'Edit Produto',
			'new_item' 				=> 'New Item',
			'view_item' 			=> 'View Produtos',
			'search_items' 			=> 'Search Produtos',
			'not_found' 			=> 'No Produtos Found',
			'not_found_in_trash' 	=> 'No Produtos in Trash',
			'parent_item_colon' 	=> '',
			'menu_name' 			=> 'Produtos'
		);
		$Produtos = array(
		...
		register_post_type( 'produto' , $Produtos );
		flush_rewrite_rules();
	}
	// WIDGETS
	register_sidebar([
	...
	add_image_size('banners', 1200, 300, true);
