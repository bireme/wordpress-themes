                        ...
                        <div class="col-md-10">
                            <div class="logo">
                                <?php if(vhl_show_title()): ?>
                                    ...
                                    <?php else: ?>
                                        <h1><a href="#"><?php bloginfo('wp_title'); ?></a></h1>
                                    <?php endif; ?>
                                <?php endif; ?>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <img src="<?= get_template_directory_uri(); ?>/static/img/bolivia.jpg" width="80px">
                        </div>
                    </div>
                </div>
            </div>
