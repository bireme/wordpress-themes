	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6" id="accessibilityFontes">
				...
				<a href="https://politicas.bireme.org/accesibilidad/<?php echo (in_array($language, ['fr']) ? "en" : $language ); ?>" role="button" id="accebilidade" tabindex="9" target="_blank" title="Acessibilidade"><i class="fas fa-wheelchair"></i></a>
			</div>
		</div>
	</div>
</section>