		...
		<div class="container">
			<div class="row">
				<div class="col-md-5">
					...
					<a href="http://politicas.bireme.org/privacidad/<?php echo $language==''?'pt':$language; ?>/" target="_blank">
						<?php pll_e('Privacy policy'); ?>
					</a>
				</div>
				<div class="col-md-7 text-end">
					<img src="http://logos.bireme.org/img/<?php echo $language==''?'pt':$language; ?>/h_bir_white.svg" alt="" class="img-fluid">
				</div>
			</div>
		</div>
	</footer>
