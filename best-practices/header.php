...
<body>
	...
	<header id="header">
		<div class="container">
			<div class="row">
				<div class="col-md-5">
					<a href="<?php echo get_option('siteurl'); ?>/<?php echo $language=='es'?'':$language; ?>"><img src="<?php bloginfo('template_directory'); ?>/img/logo-<?=$language; ?>.svg" alt="" class="img-fluid" id="logo" ></a>
				</div>
				<div class="col-md-7">
					<div id="lang">
						<?php 
