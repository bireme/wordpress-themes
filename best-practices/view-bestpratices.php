<?php
/**
 * Template Name: View Best Pratices
 *
**/
?>
<?php get_header(); ?>
		...
		<div class="row">
			<div class="col-md-9">
				<div class="bpBtAction">
					<a href="" class="btn btn-sm btn-outline-secondary" title="Imprimir"><i class="fas fa-print"></i></a>
			...
			<div class="col-md-3">
				<div class="box1 title1">
					<h4>FECHAS</h4>
					<i class="fas fa-calendar-alt"></i> Inicio: 01 agosto, 2013<br>
					<i class="fas fa-calendar-alt"></i> Finalización: 31 de enero de 2017 ¿En curso? No<br>
				</div>
				<div class="box1 title1">
					<h4>SUBREGION</h4>
					Cono Sur
